...
package xo.org.apache.tools.mail;
...
public class MailMessage {
   ...
   *
   * @exception java.io.IOException if there's any problem contacting the mail server
   */
  ...
  public MailMessage(String host, int port) throws IOException {
     ...
     * @exception java.io.IOException if there's any problem reported by the mail server
     */
