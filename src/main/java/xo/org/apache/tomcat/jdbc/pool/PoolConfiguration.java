 ...
 */
package xo.org.apache.tomcat.jdbc.pool;

import java.util.Properties;

import xo.org.apache.tomcat.jdbc.pool.PoolProperties.InterceptorDefinition;

/**
 * A list of properties that are configurable for a connection pool.
 * The {@link xo.org.apache.tomcat.jdbc.pool.DataSource} object also implements this interface so that it can be easily configured through
...
public interface PoolConfiguration {
     ...
     */
    public static final String PKG_PREFIX = "xo.org.apache.tomcat.jdbc.pool.interceptor.";
     ...
     * This uses the {@link xo.org.apache.tomcat.jdbc.pool.FairBlockingQueue} implementation for the list of the idle connections.
    ...
    /**
     * The properties that will be passed into {@link java.sql.Driver#connect(String, java.util.Properties)} method.
    ...
    /**
     * Returns the database properties that are passed into the {@link java.sql.Driver#connect(String, java.util.Properties)} method.
     * @return database properties that are passed into the {@link java.sql.Driver#connect(String, java.util.Properties)} method.
     */
    public Properties getDbProperties();

    /**
     * Overrides the database properties passed into the  {@link java.sql.Driver#connect(String, java.util.Properties)} method.
     * @param dbProperties
     */
    ...
    /**
     * Returns the default transaction isolation level. If set to {@link xo.org.apache.tomcat.jdbc.pool.DataSourceFactory#UNKNOWN_TRANSACTIONISOLATION} the method
     * {@link java.sql.Connection#setTransactionIsolation(int)} will not be called during connection creation.
     * @return driver transaction isolation level, or -1 {@link xo.org.apache.tomcat.jdbc.pool.DataSourceFactory#UNKNOWN_TRANSACTIONISOLATION} if not set.
     */
    public int getDefaultTransactionIsolation();

    /**
     * If set to {@link xo.org.apache.tomcat.jdbc.pool.DataSourceFactory#UNKNOWN_TRANSACTIONISOLATION} the method
     ...
     * {@link java.sql.Connection#TRANSACTION_SERIALIZABLE} or {@link xo.org.apache.tomcat.jdbc.pool.DataSourceFactory#UNKNOWN_TRANSACTIONISOLATION}
     ...
     * Logging of abandoned Connections adds overhead for every Connection borrow because a stack trace has to be generated.
     * The default value is false.
     * @param logAbandoned set to true if stack traces should be recorded when {@link xo.org.apache.tomcat.jdbc.pool.DataSource#getConnection()} is called.
     */
     ...
     * If a data source is set, the {@link xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#getUrl()} and {@link xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#getDriverClassName()} methods are ignored
     * and not used by the pool. If the {@link xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#getUsername()} and {@link xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#getPassword()}
    ...
    /**
     * Configure the connection pool to use a DataSource according to {@link xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#setDataSource(Object)}
     * But instead of injecting the object, specify the JNDI location.
     * After a successful JNDI look, the {@link xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#getDataSource()} will not return null.
    ...
    /**
     * Returns true if the call {@link xo.org.apache.tomcat.jdbc.pool.DataSource#getConnection(String, String) getConnection(username,password)} is
     ...
     * @return true if {@link xo.org.apache.tomcat.jdbc.pool.DataSource#getConnection(String, String) getConnection(username,password)} is honored, false if it is ignored.
     */
    public boolean isAlternateUsernameAllowed();

    /**
     * Set to true if the call {@link xo.org.apache.tomcat.jdbc.pool.DataSource#getConnection(String, String) getConnection(username,password)} is
     ...
     * @param alternateUsernameAllowed - set true if {@link xo.org.apache.tomcat.jdbc.pool.DataSource#getConnection(String, String) getConnection(username,password)} is honored,
    ...
    /**
     * @see xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#setCommitOnReturn(boolean)
     */
    ...
    /**
     * @see xo.org.apache.tomcat.jdbc.pool.PoolConfiguration#setRollbackOnReturn(boolean)
     */
