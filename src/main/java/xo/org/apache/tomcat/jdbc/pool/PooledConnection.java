...
import xo.org.apache.tomcat.jdbc.pool.interceptor.ConnectionState;
...
public class PooledConnection {
     ...
     * @throws java.sql.SQLException if the method {@link #release()} has been called.
     * @throws java.sql.SQLException if driver instantiation fails
     * @throws java.sql.SQLException if a call to {@link java.sql.Driver#connect(String, java.util.Properties)} fails.
     * @throws java.sql.SQLException if default properties are configured and a call to
    ...
    protected void connectUsingDriver() throws SQLException {
        ...
        try {
            ...
            if (parent.jmxPool!=null) {
                parent.jmxPool.notify(xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_CONNECT,
     ...
     * {@link #connect()}
     * @throws java.sql.SQLException if the call to {@link #connect()} fails.
     */
     ...
     * @param finalize if set to true, a call to {@link xo.org.apache.tomcat.jdbc.pool.ConnectionPool#finalize(xo.org.apache.tomcat.jdbc.pool.PooledConnection)} is called.
     */
...
//============================================================================
     ...
     * Object is shared with the {@link xo.org.apache.tomcat.jdbc.pool.ConnectionPool}
