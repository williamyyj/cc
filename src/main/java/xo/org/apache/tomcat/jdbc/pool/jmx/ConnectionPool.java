 ...
 */
package xo.org.apache.tomcat.jdbc.pool.jmx;
/**
 * @author Filip Hanik
 */
...
import xo.org.apache.tomcat.jdbc.pool.PoolConfiguration;
import xo.org.apache.tomcat.jdbc.pool.PoolProperties.InterceptorDefinition;
import xo.org.apache.tomcat.jdbc.pool.PoolUtilities;
import xo.org.apache.tomcat.jdbc.pool.Validator;
...
public class ConnectionPool extends NotificationBroadcasterSupport implements ConnectionPoolMBean  {
     ...
     * the connection pool
     */
    protected xo.org.apache.tomcat.jdbc.pool.ConnectionPool pool = null;
    /**
    ...
    public ConnectionPool(xo.org.apache.tomcat.jdbc.pool.ConnectionPool pool) {
        super();
        this.pool = pool;
    }

    public xo.org.apache.tomcat.jdbc.pool.ConnectionPool getPool() {
        return pool;
    }
