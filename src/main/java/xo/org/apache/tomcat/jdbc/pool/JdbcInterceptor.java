...
import xo.org.apache.tomcat.jdbc.pool.PoolProperties.InterceptorProperty;
 ...
 * {@link #invoke(Object, java.lang.reflect.Method, Object[])} method on the interceptor will be called.
 ...
 * are needed or simply override the {@link #setProperties(java.util.Map)} method.
...
public abstract class JdbcInterceptor implements InvocationHandler {
    ...
    /**
     * Set to true if string comparisons (for the {@link #compare(String, java.lang.reflect.Method)} and {@link #compare(String, String)} methods) should use the Object.equals(Object) method
