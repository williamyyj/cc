...
public class ConnectionPool {
     ...
     */
    protected xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool jmxPool = null;
     ...
     * @throws java.sql.SQLException - if the wait times out or a failure occurs creating a connection
     */
     ...
     * @throws java.sql.SQLException if an interceptor can't be configured, if the proxy can't be instantiated
     */
    ...
    protected void init(PoolConfiguration properties) throws SQLException {
        ...
        for (int i=0; i<proxies.length; i++) {
            try {
                ...
                if (jmxPool!=null) jmxPool.notify(xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_INIT, getStackTrace(x));
                close(true);
...
//===============================================================================
    ...
    protected void abandon(PooledConnection con) {
        ...
        try {
            ...
            if (jmxPool!=null) {
                jmxPool.notify(xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_ABANDON, trace);
            }
    ...
    protected void suspect(PooledConnection con) {
        ...
        try {
            ...
            if (jmxPool!=null) {
                jmxPool.notify(xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.SUSPECT_ABANDONED_NOTIFICATION, trace);
            }
            con.setSuspect(true);
        } finally {
            con.unlock();
    ...
    private PooledConnection borrowConnection(int wait, String username, String password) throws SQLException {
        ...
        while (true) {
            ...
            if (maxWait==0 && con == null) { //no wait, return one if we have one
                if (jmxPool!=null) {
                    jmxPool.notify(xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.POOL_EMPTY, "Pool empty - no wait.");
                }
            ...
            if (con == null) {
                if ((System.currentTimeMillis() - now) >= maxWait) {
                    if (jmxPool!=null) {
                        jmxPool.notify(xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.POOL_EMPTY, "Pool empty - timeout.");
                    }
                    throw new PoolExhaustedException("[" + Thread.currentThread().getName()+"] " +
     ...
     * @return con
     * @throws java.sql.SQLException if a validation error happens
     */
     ...
     */
    public xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool getJmxPool() {
        return jmxPool;
    }
    ...
    protected void createMBean() {
        try {
            jmxPool = new xo.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool(this);
        } catch (Exception x) {
