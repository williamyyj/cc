 ...
 *  <li>jdbcInterceptors - a semicolon separated list of classnames extending {@link xo.org.apache.tomcat.jdbc.pool.JdbcInterceptor} class.</li>
...
public class DataSourceFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (xo.org.apache.tomcat.jdbc.pool.DataSource.class.getName().equals(ref.getClassName())) {
            ok = true;
        }
    ...
    public DataSource createDataSource(Properties properties,Context context, boolean XA) throws Exception {
        ...
        xo.org.apache.tomcat.jdbc.pool.DataSource dataSource = XA?
                new XADataSource(poolProperties) :
                new xo.org.apache.tomcat.jdbc.pool.DataSource(poolProperties);
