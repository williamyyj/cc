...
abstract public class AbstractChecksum implements Checksum {
    ...
    public String toString() {
        return
        (hex ? getHexValue() : Long.toString(getValue())) + separator +
        length + separator +
...
/*
    public String format(String format) {
        String
        temp = GeneralString.replaceAllStrings(format, "#FINGERPRINT", "#CHECKSUM");
        temp = GeneralString.replaceAllStrings(temp, "#CHECKSUM", hex ? getHexValue() : Long.toString(getValue()) );
        temp = GeneralString.replaceAllStrings(temp, "#FILESIZE", Long.toString(length));
        temp = GeneralString.replaceAllStrings(temp, "#FILENAME", filename);
        if (isTimestampWanted())
        temp = GeneralString.replaceAllStrings(temp, "#TIMESTAMP", getTimestampFormatted());
