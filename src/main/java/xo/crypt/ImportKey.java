...
public class ImportKey  {
    ...
    public static void main ( String args[]) {
        ...
        String keypass = "okpass";
        
        // change this if you want another alias by default
        String default_alias = "pest";

        // change this if you want another keystorefile by default
        String keystorename = "pest.jks";

   


        // parsing command line input
        String keyfile = "resources/app/baphiq/pest_priv.txt";
        String certfile = "resources/app/baphiq/pest.cer";
        ...
        try {
            ...
            // storing keystore
            ks.setKeyEntry(default_alias, ff, 
                           keypass.toCharArray(),
                           certs );
            System.out.println ("Key and certificate stored.");
            System.out.println ("Alias:"+default_alias+"  Password:"+keypass);
            ks.store(new FileOutputStream ( keystorename ),
                     keypass.toCharArray());
        } catch (Exception ex) {
            ex.printStackTrace();
